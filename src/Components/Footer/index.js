    ...
    return (
        <FooterStyle >
            ...
            <FooterUl className="d-flex">
                <FooterListItem>
                    <ListItemAnchor href="/" className="nav-link active">تواصل معنا</ListItemAnchor>
                </FooterListItem>
                <FooterListItem>
                    <ListItemAnchor href="/contact" className="nav-link ">البريد الإلكتروني</ListItemAnchor>

                </FooterListItem>

                <FooterListItem>
                    <ListItemAnchor href="/contact" className="nav-link ">سياسة الخصوصية</ListItemAnchor>
